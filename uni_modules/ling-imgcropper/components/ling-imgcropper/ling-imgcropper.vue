<template>
    <view class="vue-cropper" ref="cropper" :style="{ top : `${containerTop}px` }" v-show="show" @touchmove.stop.prevent="" catchtouchmove="false" >
        <view class="cropper-box" >
            <view class="cropper-box-canvas" @touchstart.stop.prevent="imgTouchStart" @touchcancel.stop.prevent="imgcancel"  @touchmove.stop.prevent="imgMoveing" @touchend.stop.prevent="imgMoveEnd" :style="{
					'width': imageWidth + 'px',
